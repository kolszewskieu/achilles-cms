            ...
            <div class="span12">
					<div class="row-fluid">
						...
						<form name="wycena">
							...
							<div class="row-fluid">
								<div class="span12">
									...
									<?select_typ();?>
									<a class="btn btn-mini btn-primary" role="button" href="?typ=<?=$_GET[typ]?>&add=1">Dodaj nową wklejkę</a>
									</legend>
								</div>
							</div>
							</fieldset>
						...
						<div class="span12">
							...
							<div class="row-fluid">
								<div class="span12">
									<form name="edycja" method="POST" action="wyceny_formaty_wklejka.php?typ=<?=$_GET[typ]?>">
									<input type="hidden" name="typ" value="<?=$_GET[typ];?>">
										...
										$sql="SELECT * FROM format_wklejka WHERE typ='$_GET[typ]' AND del='0' ORDER BY grubosc_od,format_x_od,format_x_do,format_y_od";
										$res=mysql_query($sql);
